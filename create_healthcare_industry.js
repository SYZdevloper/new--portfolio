...
const dir = path.join('d:', 'new website', 'hyperlink-nextjs-app-router', 'app', 'industries', 'hospitals-clinics-healthcare-providers');
...
`;
fs.writeFileSync(path.join(dir, 'HealthcareClientScripts.tsx'), clientScripts, 'utf8');
...
console.log("Healthcare Industry Page Generated successfully!");
