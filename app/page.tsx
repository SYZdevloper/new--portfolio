        ...
        <header className="site-header" id="site-header">
          <nav className="nav" aria-label="Main navigation">
            <a className="brand" href="/" aria-label="Hyperlink Tech Solutions home">
              <span className="brand-logo" aria-hidden="true">
                <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                    <linearGradient id="hyperlinkAccent" x1="16" y1="24" x2="32" y2="24" gradientUnits="userSpaceOnUse">
            ...
            <div className="nav-actions">
              ...
              <a className="btn primary js-open-proposal" href="#contact">Get Proposal</a>
              <button className="menu-btn" type="button" aria-label="Open navigation menu" aria-expanded="false" aria-controls="mobile-navigation">
                <span></span>
              </button>
            </div>
          </nav>
          ...
          <section className="section soft" id="work" aria-labelledby="work-title">
            <div className="container">
              <div className="section-heading">
                ...
                <p>Three highlighted projects in one row. Replace the image, project details and redirect URL inside each card with your genuine work.</p>
              </div>
              <WorkCarousel />
              <div className="work-footer">
                <p>
                  Every complete card is clickable and redirects through its
                  <code>href</code>
                  . Use a live project URL or a dedicated case-study page.
                </p>
                <a className="btn" href="/work/">
                  View All Work
                  <span className="arrow">↗</span>
                ...
                <form className="lead-form js-lead-form" data-form-name="Main Proposal Form" action="/api/leads" method="post" noValidate>
                  ...
                  <div className="field-row">
                    ...
                    <div className="field">
                      ...
                      <input id="main-phone" name="phone" type="tel" required autoComplete="tel" placeholder="+91 98XXXXXX" />
                    </div>
                  </div>
                  <div className="field-row">
                    <div className="field">
            ...
            <form className="lead-form js-lead-form" id="proposal-form" data-form-name="Proposal Popup Form" action="/api/leads" method="post" noValidate>
              <div className="field-row">
                ...
                <div className="field">
                  ...
                  <input id="popup-phone" name="phone" type="tel" required autoComplete="tel" placeholder="+91 98XXXXXX" />
                </div>
              </div>
              <div className="field-row">
                <div className="field">
