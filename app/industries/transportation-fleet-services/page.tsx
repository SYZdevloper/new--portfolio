...
import "./transportation-fleet-services.css";
...
export default function TransportationFleetServicesPage() {
  return (
    <>
            ...
            <section className="hero" data-block-type="hero" data-block-id="industry-hero">
                <div className="container">
                    <div className="breadcrumbs"><a href="/">Home</a><span>/</span><a
                            href="/industries/">Industries</a><span>/</span><strong>Transportation &amp; Fleet
                            Services</strong></div>
                    <div className="hero-grid">
                        <div className="hero-copy reveal">
                            <p className="eyebrow">Transportation &amp; Fleet Services</p>
                            <h1>Connect passengers, customers, vehicles and fleet operations through practical digital
                                tools.</h1>
                            <p className="hero-lead">We build booking systems, customer portals and fleet dashboards for
                                passenger, charter, commercial and managed-transport providers.</p>
                            <div className="hero-points"><span>Explain routes, services, vehicles and capacity
                                    clearly</span><span>Connect enquiries, reservations, trips and
                                    payments</span><span>Support drivers, vehicles, maintenance and operational
                                    reporting</span></div>
                        ...
                        <aside className="review-card reveal-right" id="free-review"><span className="review-badge">Free Transportation &amp;
                                Fleet Services review</span>
                            ...
                            <form className="compact-form js-demo-form" action="/api/leads" method="post"><input
                                    ...
                                    value="industries/transportation-fleet-services" /><input type="hidden" name="offer"
                                    value="free-industries/transportation-fleet-services-review" /><input name="email"
                                    ...
                                    <option>Transport Service Websites</option>
                                    <option>Reservations &amp; Trip Booking</option>
                                    <option>Customer &amp; Corporate Portals</option>
                                    <option>Fleet, Driver &amp; Maintenance</option>
                ...
                <div className="container">
                    ...
                    <div className="problem-grid">
                        <article className="problem-card reveal-zoom"><span className="problem-num">01</span>
                            <h3>Customers cannot easily compare service options.</h3>
                            <p>The current journey creates avoidable manual work, uncertainty or repeated follow-up.</p>
                            <span className="outcome">Outcome: Clear routes, vehicle, capacity and booking journeys</span>
                        </article>
                        <article className="problem-card reveal-zoom"><span className="problem-num">02</span>
                            <h3>Trip details are re-entered across teams.</h3>
                            <p>The current journey creates avoidable manual work, uncertainty or repeated follow-up.</p>
                            <span className="outcome">Outcome: One reservation, assignment and status workflow</span>
                        </article>
                        <article className="problem-card reveal-zoom"><span className="problem-num">03</span>
                            <h3>Fleet availability and maintenance are disconnected.</h3>
                            <p>The current journey creates avoidable manual work, uncertainty or repeated follow-up.</p>
                            <span className="outcome">Outcome: Connected vehicle, trip and service visibility</span>
                        </article>
                    </div>
                </div>
            </section>
                    ...
                    <div className="solutions-shell">
                        <div className="solution-tabs reveal">
                            ...
                            <h2>Connected digital capabilities across the industry lifecycle.</h2><button
                                className="solution-tab active" data-key="services"><span>01</span><span>Transport Service
                                    Websites</span><span>→</span></button><button className="solution-tab"
                                data-key="booking"><span>02</span><span>Reservations &amp; Trip
                                    Booking</span><span>→</span></button><button className="solution-tab"
                                data-key="customers"><span>03</span><span>Customer &amp; Corporate
                                    Portals</span><span>→</span></button><button className="solution-tab"
                                data-key="fleet"><span>04</span><span>Fleet, Driver &amp;
                                    Maintenance</span><span>→</span></button><button className="solution-tab"
                        ...
                        <div className="solution-panel reveal-right">
                            <div className="solution-copy"><span className="mini" id="solutionKicker">Service discovery</span>
                                <h3 id="solutionTitle">Help customers choose the right transport service.</h3>
                                <p id="solutionText">Structure routes, charters, vehicles, capacity, accessibility,
                                    service areas, policies and enquiries.</p>
                                <div className="solution-list" id="solutionList"><span>Route and service
                                        pages</span><span>Fleet showcase</span><span>Qualified enquiries</span></div><a
                                    className="btn" href="#project-enquiry">Discuss this capability →</a>
                            </div>
                            <div className="ui-window" aria-hidden="true">
                                <div className="ui-top">
                                    <div className="ui-dots"><i></i><i></i><i></i></div><span className="ui-badge"
                                        id="uiBadge">Transport Service Websites</span>
                                </div>
            ...
            <section className="section soft" data-block-type="childIndustryGrid">
                <div className="container">
                    ...
                    <div className="category-grid"><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Passenger Transport Operators</h3>
                            <p>Routes, bookings, travellers, vehicles and service.</p><span>Discuss category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Bus &amp; Coach Companies</h3>
                            <p>Schedules, charters, tickets, fleets and operations.</p><span>Discuss category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Corporate Transport Services</h3>
                            <p>Accounts, employees, trips, invoices and reporting.</p><span>Discuss category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>School &amp; Institutional Transport</h3>
                            <p>Routes, riders, guardians, vehicles, alerts and attendance inputs.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Commercial Fleet Operators</h3>
                            <p>Customers, vehicles, drivers, jobs, maintenance and analytics.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Fleet Management Providers</h3>
                            <p>Assets, inspections, service, costs, alerts and reporting.</p><span>Discuss
                                category</span>
                        </a></div>
                </div>
            </section>
            <section className="section" data-block-type="faq" id="faq">
                <div className="container">
                    ...
                    <div className="faq-list">
                        <div className="faq-item open"><button className="faq-question"><span>What transport and fleet
                                    businesses do you support?</span><span>−</span></button>
                            <div className="faq-answer">
                                <p>We support passenger, coach, corporate, institutional and commercial transport
                                    businesses and fleet managers.</p>
                            </div>
                        </div>
                        <div className="faq-item reveal"><button className="faq-question"><span>Can customers book scheduled or charter
                                    trips?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>Yes. Workflows can support routes, dates, passenger or cargo needs, vehicle options,
                                    quotes, payments and confirmation.</p>
                            </div>
                        </div>
                        <div className="faq-item reveal"><button className="faq-question"><span>Can the platform track
                                    vehicles?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>Potentially, through approved telematics or tracking interfaces. Accuracy and refresh
                                    rates depend on the provider.</p>
                            </div>
                        </div>
                        <div className="faq-item reveal"><button className="faq-question"><span>Can fleet teams manage inspections and
                                    maintenance?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>Yes. The platform can support vehicles, checks, defects, work orders, documents,
                                    expiry and service history.</p>
                            </div>
                        </div>
                        ...
                        <div className="faq-item reveal"><button className="faq-question"><span>Does the platform replace regulated
                                    dispatch or safety systems?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>Not automatically. Safety-critical and regulated systems require separate specialist
                                    engineering and approval.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="final-box">
                        <div className="final-copy">
                            <p className="eyebrow" style={{"color":"#cdbdff"}}>Have a Transportation &amp; Fleet Services project?
                            </p>
                        ...
                        <form className="full-form js-demo-form" action="/api/leads" method="post"><input type="hidden"
                                name="source_page" value="industries/transportation-fleet-services" /><input type="hidden"
                                name="offer" value="industries/transportation-fleet-services-project-proposal" />
      ...
      <SiteFooter />
      <TransportationFleetServicesClientScripts />
    </>
  );
}
