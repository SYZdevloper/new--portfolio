            ...
            <section className="hero" data-block-type="hero" data-block-id="industry-hero">
                <div className="container">
                    <div className="breadcrumbs"><a href="/">Home</a><span>/</span><a
                            href="/industries/">Industries</a><span>/</span><strong>Oil &amp; Gas</strong></div>
                    <div className="hero-grid">
                        <div className="hero-copy reveal">
                            <p className="eyebrow">Oil &amp; Gas</p>
                            <h1>Connect technical capability, suppliers, assets and stakeholders through controlled
                                digital workflows.</h1>
                            <p className="hero-lead">We build corporate platforms, supplier portals, service systems and
                                dashboards for upstream, midstream, downstream and energy-service businesses.</p>
                            <div className="hero-points"><span>Present operations, services, projects and assurance
                                    information clearly</span><span>Connect suppliers, contractors, documents and
                                    approved workflows</span><span>Support assets, inspections, maintenance, incidents
                        ...
                        <aside className="review-card reveal-right" id="free-review"><span className="review-badge">Free Oil &amp; Gas
                                review</span>
                            ...
                            <form className="compact-form js-demo-form" action="/api/leads" method="post"><input
                                    type="hidden" name="source_page" value="industries/oil-gas" /><input type="hidden"
                                    name="offer" value="free-industries/oil-gas-review" /><input name="email" type="email"
                                    ...
                                    <option>Corporate &amp; Capability Platforms</option>
                                    <option>Supplier &amp; Contractor Portals</option>
                                    <option>Project &amp; Partner Portals</option>
                                    <option>Asset, Inspection &amp; Maintenance</option>
                                    <option>Operations &amp; HSE Dashboards</option>
                ...
                <div className="container">
                    ...
                    <div className="problem-grid">
                        <article className="problem-card reveal-zoom"><span className="problem-num">01</span>
                            <h3>Complex capabilities are described without operational proof.</h3>
                            <p>The current journey creates avoidable manual work, uncertainty or repeated follow-up.</p>
                            <span className="outcome">Outcome: Structured assets, services, projects and assurance
                                evidence</span>
                        </article>
                        <article className="problem-card reveal-zoom"><span className="problem-num">02</span>
                            <h3>Supplier onboarding depends on repeated document exchange.</h3>
                            <p>The current journey creates avoidable manual work, uncertainty or repeated follow-up.</p>
                            <span className="outcome">Outcome: Controlled registration, review and expiry workflows</span>
                        </article>
                        <article className="problem-card reveal-zoom"><span className="problem-num">03</span>
                            <h3>Operational evidence is fragmented across systems.</h3>
                            <p>The current journey creates avoidable manual work, uncertainty or repeated follow-up.</p>
                            <span className="outcome">Outcome: Focused asset, maintenance and exception visibility</span>
                        </article>
                    </div>
                </div>
            </section>
                    ...
                    <div className="solutions-shell">
                        <div className="solution-tabs reveal">
                            ...
                            <h2>Connected digital capabilities across the industry lifecycle.</h2><button
                                ...
                                data-key="suppliers"><span>02</span><span>Supplier &amp; Contractor
                                    Portals</span><span>→</span></button><button className="solution-tab"
                                data-key="projects"><span>03</span><span>Project &amp; Partner
                                    Portals</span><span>→</span></button><button className="solution-tab"
                                data-key="assets"><span>04</span><span>Asset, Inspection &amp;
                                    Maintenance</span><span>→</span></button><button className="solution-tab"
                                data-key="operations"><span>05</span><span>Operations &amp; HSE
                                    Dashboards</span><span>→</span></button>
                        </div>
                        <div className="solution-panel reveal-right">
                            <div className="solution-copy"><span className="mini" id="solutionKicker">Stakeholder
                                    confidence</span>
                                <h3 id="solutionTitle">Explain operations, capabilities and responsible-business
                                    information.</h3>
                                <p id="solutionText">Structure segments, assets, services, projects, locations,
                                    governance, sustainability and news.</p>
                                <div className="solution-list" id="solutionList"><span>Corporate
                                        architecture</span><span>Asset and project pages</span><span>Governance and
                                        sustainability</span></div><a className="btn" href="#project-enquiry">Discuss this
                                    capability →</a>
                            </div>
                            <div className="ui-window" aria-hidden="true">
                                <div className="ui-top">
                                    <div className="ui-dots"><i></i><i></i><i></i></div><span className="ui-badge"
                                        id="uiBadge">Corporate &amp; Capability Platforms</span>
                                </div>
            ...
            <section className="section soft" data-block-type="childIndustryGrid">
                <div className="container">
                    ...
                    <div className="category-grid"><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Upstream Operators</h3>
                            <p>Assets, projects, suppliers, operations, maintenance and reporting.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Midstream &amp; Pipeline Businesses</h3>
                            <p>Networks, integrity, maintenance, stakeholders and incidents.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Refining &amp; Downstream Companies</h3>
                            <p>Facilities, products, distributors, operations and assurance.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Oilfield Service Providers</h3>
                            <p>Capabilities, equipment, tenders, field service and customer portals.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Engineering &amp; Project Partners</h3>
                            <p>Programmes, documents, suppliers, milestones and governance.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>HSE &amp; Inspection Services</h3>
                            <p>Inspections, findings, actions, evidence and reporting.</p><span>Discuss category</span>
                        </a></div>
                </div>
            </section>
            <section className="section" data-block-type="faq" id="faq">
                <div className="container">
                    ...
                    <div className="faq-list">
                        <div className="faq-item open"><button className="faq-question"><span>What oil and gas businesses do you
                                    support?</span><span>−</span></button>
                            <div className="faq-answer">
                                <p>We support upstream, midstream and downstream companies, service providers,
                                    engineering partners and inspection organisations.</p>
                            </div>
                        </div>
                        <div className="faq-item reveal"><button className="faq-question"><span>Can you build supplier onboarding and
                                    assurance workflows?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>Yes. Portals can support questionnaires, evidence, reviews, approvals, expiries,
                                    findings and authorised reporting.</p>
                            </div>
                        </div>
                        <div className="faq-item reveal"><button className="faq-question"><span>Can the platform manage inspection and
                                    maintenance records?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>It can support approved workflows and visibility; authoritative integrity and safety
                                    records must remain in compliant systems and processes.</p>
                            </div>
                        </div>
                        <div className="faq-item reveal"><button className="faq-question"><span>Can public and restricted information
                                    be separated?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>Yes. Content, organisations, roles, files and workflows can use defined access
                                    boundaries.</p>
                            </div>
                        </div>
                ...
                <div className="container">
                    <div className="final-box">
                        <div className="final-copy">
                            <p className="eyebrow" style={{"color":"#cdbdff"}}>Have a Oil &amp; Gas project?</p>
                        ...
                        <form className="full-form js-demo-form" action="/api/leads" method="post"><input type="hidden"
                                name="source_page" value="industries/oil-gas" /><input type="hidden" name="offer"
                                value="industries/oil-gas-project-proposal" />
