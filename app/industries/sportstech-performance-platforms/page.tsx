...
import "./sportstech-performance-platforms.css";
...
export default function SportstechPerformancePlatformsPage() {
  return (
    <>
            ...
            <section className="hero" data-block-type="hero" data-block-id="industry-hero">
                <div className="container">
                    <div className="breadcrumbs"><a href="/">Home</a><span>/</span><a
                            href="/industries/">Industries</a><span>/</span><strong>SportsTech &amp; Performance
                            Platforms</strong></div>
                    <div className="hero-grid">
                        <div className="hero-copy reveal">
                            <p className="eyebrow">SportsTech &amp; Performance Platforms</p>
                            <h1>Turn sports data, coaching workflows and performance products into clear digital
                                experiences.</h1>
                            <p className="hero-lead">We build product websites, athlete portals and analytics platforms for
                                sports-technology, coaching and performance businesses.</p>
                            <div className="hero-points"><span>Explain products, methods, devices and performance outcomes
                                    clearly</span><span>Connect athletes, coaches, teams and training
                                    workflows</span><span>Support sessions, assessments, data integrations and
                                    reporting</span></div>
                        ...
                        <aside className="review-card reveal-right" id="free-review"><span className="review-badge">Free SportsTech &amp;
                                Performance Platforms review</span>
                            ...
                            <form className="compact-form js-demo-form" action="/api/leads" method="post"><input
                                    ...
                                    value="industries/sportstech-performance-platforms" /><input type="hidden"
                                    name="offer" value="free-industries/sportstech-performance-platforms-review" /><input
                                    ...
                                    <option>SportsTech Product Websites</option>
                                    <option>Athlete &amp; Coach Portals</option>
                                    <option>Testing &amp; Assessment Workflows</option>
                                    <option>Device &amp; Data Integrations</option>
                                    <option>Performance Dashboards</option>
                ...
                <div className="container">
                    ...
                    <div className="problem-grid">
                        <article className="problem-card reveal-zoom"><span className="problem-num">01</span>
                            <h3>Technology benefits are difficult to explain.</h3>
                            <p>The current journey creates avoidable manual work, uncertainty or repeated follow-up.</p>
                            <span className="outcome">Outcome: Clear use cases, evidence and product journeys</span>
                        </article>
                        <article className="problem-card reveal-zoom"><span className="problem-num">02</span>
                            <h3>Athlete and coach data lives in separate tools.</h3>
                            <p>The current journey creates avoidable manual work, uncertainty or repeated follow-up.</p>
                            <span className="outcome">Outcome: Role-based profiles, sessions and shared workflows</span>
                        </article>
                        <article className="problem-card reveal-zoom"><span className="problem-num">03</span>
                            <h3>Dashboards show metrics without useful context.</h3>
                            <p>The current journey creates avoidable manual work, uncertainty or repeated follow-up.</p>
                            <span className="outcome">Outcome: Goal, benchmark and decision-oriented reporting</span>
                        </article>
                    </div>
                </div>
            </section>
                    ...
                    <div className="solutions-shell">
                        <div className="solution-tabs reveal">
                            ...
                            <h2>Connected digital capabilities across the industry lifecycle.</h2><button
                                className="solution-tab active" data-key="product"><span>01</span><span>SportsTech Product
                                    Websites</span><span>→</span></button><button className="solution-tab"
                                data-key="athletes"><span>02</span><span>Athlete &amp; Coach
                                    Portals</span><span>→</span></button><button className="solution-tab"
                                data-key="assessment"><span>03</span><span>Testing &amp; Assessment
                                    Workflows</span><span>→</span></button><button className="solution-tab"
                                data-key="data"><span>04</span><span>Device &amp; Data
                                    Integrations</span><span>→</span></button><button className="solution-tab"
                                data-key="analytics"><span>05</span><span>Performance
                        ...
                        <div className="solution-panel reveal-right">
                            <div className="solution-copy"><span className="mini" id="solutionKicker">Product clarity</span>
                                <h3 id="solutionTitle">Help teams and athletes understand the product and its value.
                                </h3>
                                <p id="solutionText">Structure audiences, use cases, features, devices, integrations,
                                    evidence, pricing and demos.</p>
                                <div className="solution-list" id="solutionList"><span>Use-case pages</span><span>Product
                                        demonstrations</span><span>Evidence and integrations</span></div><a className="btn"
                                    href="#project-enquiry">Discuss this capability →</a>
                            </div>
                            <div className="ui-window" aria-hidden="true">
                                <div className="ui-top">
                                    <div className="ui-dots"><i></i><i></i><i></i></div><span className="ui-badge"
                                        id="uiBadge">SportsTech Product Websites</span>
                                </div>
            ...
            <section className="section soft" data-block-type="childIndustryGrid">
                <div className="container">
                    ...
                    <div className="category-grid"><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Performance Software Companies</h3>
                            <p>Athletes, teams, plans, assessments, data and analytics.</p><span>Discuss category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Wearable &amp; Sensor Brands</h3>
                            <p>Products, integrations, athlete data, support and insights.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Video &amp; Analysis Platforms</h3>
                            <p>Capture, tagging, review, collaboration and performance reporting.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Coaching Technology</h3>
                            <p>Programs, coaches, athletes, communication and subscriptions.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Sports Science Providers</h3>
                            <p>Assessments, protocols, results, reports and client portals.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Team &amp; Academy Platforms</h3>
                            <p>Rosters, training, attendance, testing and development.</p><span>Discuss category</span>
                        </a></div>
                </div>
            </section>
            <section className="section" data-block-type="faq" id="faq">
                <div className="container">
                    ...
                    <div className="faq-list">
                        <div className="faq-item open"><button className="faq-question"><span>What SportsTech businesses do you
                                    support?</span><span>−</span></button>
                            <div className="faq-answer">
                                <p>We support performance software, wearables, sensors, video analysis, coaching
                                    technology, sports science and academy platforms.</p>
                            </div>
                        </div>
                        <div className="faq-item reveal"><button className="faq-question"><span>Can athlete and coach permissions be
                                    separated?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>Yes. Roles can limit teams, athletes, metrics, files, comments and administrative
                                    actions.</p>
                            </div>
                        </div>
                        <div className="faq-item reveal"><button className="faq-question"><span>Can the platform integrate wearable or
                                    sensor data?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>Potentially, through supported APIs and permissions. Data quality, ownership and
                                    refresh frequency depend on the provider.</p>
                            </div>
                        </div>
                        <div className="faq-item reveal"><button className="faq-question"><span>Can dashboards compare athletes and
                                    benchmarks?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>Yes, using approved metrics, cohorts, privacy rules and clearly defined calculations.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="faq-item reveal"><button className="faq-question"><span>Does the platform provide medical
                                    diagnosis?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>No. Medical interpretation, diagnosis and return-to-play decisions require qualified
                                    professionals and appropriate governance.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="final-box">
                        <div className="final-copy">
                            <p className="eyebrow" style={{"color":"#cdbdff"}}>Have a SportsTech &amp; Performance Platforms
                                project?</p>
                        ...
                        <form className="full-form js-demo-form" action="/api/leads" method="post"><input type="hidden"
                                name="source_page" value="industries/sportstech-performance-platforms" /><input
                                type="hidden" name="offer"
                                value="industries/sportstech-performance-platforms-project-proposal" />
      ...
      <SiteFooter />
      <SportstechPerformancePlatformsClientScripts />
    </>
  );
}
