...
import "./architecture-interiors-property-services.css";
...
export default function ArchitectureInteriorsPropertyServicesPage() {
  return (
    <>
            ...
            <section className="hero" data-block-type="hero" data-block-id="industry-hero">
                <div className="container">
                    <div className="breadcrumbs"><a href="/">Home</a><span>/</span><a
                            href="/industries/">Industries</a><span>/</span><strong>Architecture, Interiors &amp;
                            Property Services</strong></div>
                    <div className="hero-grid">
                        <div className="hero-copy reveal">
                            <p className="eyebrow">Architecture, Interiors &amp; Property Services</p>
                            <h1>Turn portfolios, services and client collaboration into a stronger built-environment
                                experience.</h1>
                            <p className="hero-lead">We build websites, project portals and service systems for architects,
                                interior designers, property managers, facility teams and specialist consultants.</p>
                            <div className="hero-points"><span>Present work through clear sectors, services and project
                                    stories</span><span>Connect consultations, briefs, proposals and client
                                    approvals</span><span>Support properties, requests, documents, vendors and service
                                    reporting</span></div>
                        ...
                        <aside className="review-card reveal-right" id="free-review"><span className="review-badge">Free Architecture,
                                Interiors &amp; Property Services review</span>
                            ...
                            <form className="compact-form js-demo-form" action="/api/leads" method="post"><input
                                    ...
                                    value="industries/architecture-interiors-property-services" /><input type="hidden"
                                    name="offer"
                                    value="free-industries/architecture-interiors-property-services-review" /><input
                                    ...
                                    <option>Portfolio &amp; Practice Websites</option>
                                    <option>Consultations &amp; Proposal Journeys</option>
                                    <option>Client Project Portals</option>
                                    <option>Property &amp; Facility Workflows</option>
                                    <option>Practice &amp; Service Dashboards</option>
                ...
                <div className="container">
                    ...
                    <div className="problem-grid">
                        <article className="problem-card reveal-zoom"><span className="problem-num">01</span>
                            <h3>Beautiful projects lack useful context.</h3>
                            <p>The current journey creates avoidable manual work, uncertainty or repeated follow-up.</p>
                            <span className="outcome">Outcome: Portfolio stories tied to challenge, scope and outcome</span>
                        </article>
                        <article className="problem-card reveal-zoom"><span className="problem-num">02</span>
                            <h3>Client decisions disappear across email threads.</h3>
                            <p>The current journey creates avoidable manual work, uncertainty or repeated follow-up.</p>
                            <span className="outcome">Outcome: Structured briefs, files, comments and approvals</span>
                        </article>
                        <article className="problem-card reveal-zoom"><span className="problem-num">03</span>
                            <h3>Property requests are difficult to prioritise.</h3>
                            <p>The current journey creates avoidable manual work, uncertainty or repeated follow-up.</p>
                            <span className="outcome">Outcome: Clear assets, cases, vendors and service states</span>
                        </article>
                    </div>
                </div>
            </section>
                    ...
                    <div className="solutions-shell">
                        <div className="solution-tabs reveal">
                            ...
                            <h2>Connected digital capabilities across the industry lifecycle.</h2><button
                                className="solution-tab active" data-key="portfolio"><span>01</span><span>Portfolio &amp;
                                    Practice Websites</span><span>→</span></button><button className="solution-tab"
                                data-key="enquiries"><span>02</span><span>Consultations &amp; Proposal
                                    Journeys</span><span>→</span></button><button className="solution-tab"
                                data-key="clients"><span>03</span><span>Client Project
                                    Portals</span><span>→</span></button><button className="solution-tab"
                                data-key="property"><span>04</span><span>Property &amp; Facility
                                    Workflows</span><span>→</span></button><button className="solution-tab"
                                data-key="operations"><span>05</span><span>Practice &amp; Service
                                    Dashboards</span><span>→</span></button>
                        </div>
                        <div className="solution-panel reveal-right">
                            <div className="solution-copy"><span className="mini" id="solutionKicker">Design authority</span>
                                <h3 id="solutionTitle">Show work with enough context to support a buying decision.</h3>
                                <p id="solutionText">Structure sectors, services, projects, locations, teams, awards,
                                    process and insights.</p>
                                <div className="solution-list" id="solutionList"><span>Project case
                                        studies</span><span>Sector and service pages</span><span>Team and
                                        expertise</span></div><a className="btn" href="#project-enquiry">Discuss this
                                    capability →</a>
                            </div>
                            <div className="ui-window" aria-hidden="true">
                                <div className="ui-top">
                                    <div className="ui-dots"><i></i><i></i><i></i></div><span className="ui-badge"
                                        id="uiBadge">Portfolio &amp; Practice Websites</span>
                                </div>
            ...
            <section className="section soft" data-block-type="childIndustryGrid">
                <div className="container">
                    ...
                    <div className="category-grid"><a className="category-card" href="#project-enquiry"><b>↗</b>
                            ...
                            <p>Portfolios, sectors, teams, enquiries and project collaboration.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Interior Design Studios</h3>
                            <p>Projects, styles, consultations, briefs, approvals and procurement.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Property Management Firms</h3>
                            <p>Properties, tenants, cases, vendors, inspections and reporting.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Facility Management Services</h3>
                            <p>Assets, work orders, planned maintenance, teams and service levels.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Landscape &amp; Urban Design</h3>
                            <p>Public realm, master planning, projects, stakeholders and consultations.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Built-Environment Consultants</h3>
                            <p>Expertise, studies, appointments, documents and client portals.</p><span>Discuss
                                category</span>
                        </a></div>
                </div>
            </section>
            <section className="section" data-block-type="faq" id="faq">
                <div className="container">
                    ...
                    <div className="faq-list">
                        <div className="faq-item open"><button className="faq-question"><span>What built-environment businesses
                                    do you support?</span><span>−</span></button>
                            <div className="faq-answer">
                                <p>We support architecture and interior practices, property and facility managers,
                                    landscape firms and specialist built-environment consultants.</p>
                            </div>
                        </div>
                        <div className="faq-item reveal"><button className="faq-question"><span>Can you build a visual project
                                    portfolio?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>Yes. Projects can be organised by sector, service, location, scale, style and outcome
                                    with approved media and credits.</p>
                            </div>
                        </div>
                        <div className="faq-item reveal"><button className="faq-question"><span>Can clients review files and record
                                    approvals?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>Yes. Portals can support versions, comments, decisions, approvals, milestones and
                                    audit information.</p>
                            </div>
                        </div>
                        <div className="faq-item reveal"><button className="faq-question"><span>Can tenants or occupants submit service
                                    requests?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>Yes. Requests can include location, category, priority, media, status, communication
                                    and satisfaction feedback.</p>
                            </div>
                        </div>
                        ...
                        <div className="faq-item reveal"><button className="faq-question"><span>Who owns image and project-publication
                                    permissions?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>The client must approve project confidentiality, photography rights, consultant
                                    credits and information allowed for public use.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="final-box">
                        <div className="final-copy">
                            <p className="eyebrow" style={{"color":"#cdbdff"}}>Have a Architecture, Interiors &amp; Property
                                Services project?</p>
                        ...
                        <form className="full-form js-demo-form" action="/api/leads" method="post"><input type="hidden"
                                name="source_page" value="industries/architecture-interiors-property-services" /><input
                                type="hidden" name="offer"
                                value="industries/architecture-interiors-property-services-project-proposal" />
      ...
      <SiteFooter />
      <ArchitectureInteriorsPropertyServicesClientScripts />
    </>
  );
}
