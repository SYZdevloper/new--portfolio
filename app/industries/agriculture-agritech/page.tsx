...
import "./agriculture-agritech.css";
...
export default function AgricultureAgritechPage() {
  return (
    <>
            ...
            <section className="hero" data-block-type="hero" data-block-id="industry-hero">
                <div className="container">
                    <div className="breadcrumbs"><a href="/">Home</a><span>/</span><a
                            href="/industries/">Industries</a><span>/</span><strong>Agriculture &amp; Agritech</strong>
                    </div>
                    <div className="hero-grid">
                        <div className="hero-copy reveal">
                            <p className="eyebrow">Agriculture &amp; Agritech</p>
                            <h1>Connect agricultural products, farmers, advisers and field operations through practical
                                digital tools.</h1>
                            <p className="hero-lead">We build product platforms, farmer portals, advisory systems and
                                dashboards for agritech companies, input businesses, cooperatives and
                                agricultural-service organisations.</p>
                            <div className="hero-points"><span>Present products, crops, applications and technical guidance
                                    clearly</span><span>Connect farmers, dealers, advisers, services and
                                    support</span><span>Support fields, activities, records, alerts and operational
                                    reporting</span></div>
                        ...
                        <aside className="review-card reveal-right" id="free-review"><span className="review-badge">Free Agriculture &amp;
                                Agritech review</span>
                            ...
                            <form className="compact-form js-demo-form" action="/api/leads" method="post"><input
                                    type="hidden" name="source_page" value="industries/agriculture-agritech" /><input
                                    type="hidden" name="offer"
                                    value="free-industries/agriculture-agritech-review" /><input name="email" type="email"
                                    ...
                                    <option>Agricultural Product Platforms</option>
                                    <option>Farmer &amp; Adviser Portals</option>
                                    <option>Dealer &amp; Commerce Workflows</option>
                                    <option>Field Data &amp; Service Workflows</option>
                                    <option>Farm &amp; Programme Dashboards</option>
                ...
                <div className="container">
                    ...
                    <div className="problem-grid">
                        <article className="problem-card reveal-zoom"><span className="problem-num">01</span>
                            <h3>Product guidance is difficult to match to local needs.</h3>
                            <p>The current journey creates avoidable manual work, uncertainty or repeated follow-up.</p>
                            <span className="outcome">Outcome: Crop, region, application and stage-based discovery</span>
                        </article>
                        <article className="problem-card reveal-zoom"><span className="problem-num">02</span>
                            <h3>Farmer and dealer interactions remain fragmented.</h3>
                            <p>The current journey creates avoidable manual work, uncertainty or repeated follow-up.</p>
                            <span className="outcome">Outcome: Connected accounts, enquiries, orders and advisory
                                workflows</span>
                        </article>
                        <article className="problem-card reveal-zoom"><span className="problem-num">03</span>
                            <h3>Field records are inconsistent and difficult to analyse.</h3>
                            <p>The current journey creates avoidable manual work, uncertainty or repeated follow-up.</p>
                            <span className="outcome">Outcome: Structured activities, evidence, alerts and dashboard
                                visibility</span>
                        </article>
                    </div>
                </div>
                    ...
                    <div className="solutions-shell">
                        <div className="solution-tabs reveal">
                            ...
                            <h2>Connected digital capabilities across the industry lifecycle.</h2><button
                                className="solution-tab active" data-key="products"><span>01</span><span>Agricultural
                                    Product Platforms</span><span>→</span></button><button className="solution-tab"
                                data-key="farmers"><span>02</span><span>Farmer &amp; Adviser
                                    Portals</span><span>→</span></button><button className="solution-tab"
                                data-key="commerce"><span>03</span><span>Dealer &amp; Commerce
                                    Workflows</span><span>→</span></button><button className="solution-tab"
                                data-key="field"><span>04</span><span>Field Data &amp; Service
                                    Workflows</span><span>→</span></button><button className="solution-tab"
                                data-key="analytics"><span>05</span><span>Farm &amp; Programme
                                    Dashboards</span><span>→</span></button>
                        </div>
                        <div className="solution-panel reveal-right">
                            <div className="solution-copy"><span className="mini" id="solutionKicker">Relevant discovery</span>
                                <h3 id="solutionTitle">Help users find products and guidance relevant to crops and
                                    conditions.</h3>
                                <p id="solutionText">Structure categories, crops, stages, applications, specifications,
                                    documents and dealer actions.</p>
                                <div className="solution-list" id="solutionList"><span>Crop and application
                                        search</span><span>Product and technical pages</span><span>Dealer and enquiry
                            ...
                            <div className="ui-window" aria-hidden="true">
                                <div className="ui-top">
                                    <div className="ui-dots"><i></i><i></i><i></i></div><span className="ui-badge"
                                        id="uiBadge">Agricultural Product Platforms</span>
                                </div>
            ...
            <section className="section soft" data-block-type="childIndustryGrid">
                <div className="container">
                    ...
                    <div className="category-grid"><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Agritech Platforms</h3>
                            <p>Farmers, fields, advisory, data, services and analytics.</p><span>Discuss category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Seed &amp; Crop-Input Companies</h3>
                            <p>Products, crops, dealers, technical content and support.</p><span>Discuss category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Farm Equipment &amp; Technology</h3>
                            <p>Products, demonstrations, dealers, service and connected tools.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Cooperatives &amp; Producer Organisations</h3>
                            <p>Members, services, procurement, aggregation and communication.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Agricultural Advisory Services</h3>
                            <p>Field visits, recommendations, tasks, documents and reporting.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Agricultural Marketplaces</h3>
                            <p>Products, suppliers, buyers, orders, logistics and trust workflows.</p><span>Discuss
                                category</span>
                        </a></div>
                </div>
            </section>
            <section className="section" data-block-type="faq" id="faq">
                <div className="container">
                    ...
                    <div className="faq-list">
                        <div className="faq-item open"><button className="faq-question"><span>What agriculture and agritech
                                    businesses do you support?</span><span>−</span></button>
                            <div className="faq-answer">
                                <p>We support agritech platforms, input companies, equipment businesses, cooperatives,
                                    advisory services and agricultural marketplaces.</p>
                            </div>
                        </div>
                        <div className="faq-item reveal"><button className="faq-question"><span>Can farmers use the platform on mobile
                                    devices?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>Yes. We design responsive, low-friction workflows and can scope offline or
                                    low-connectivity needs separately.</p>
                            </div>
                        </div>
                        <div className="faq-item reveal"><button className="faq-question"><span>Can products be organised by crop and
                                    application?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>Yes. Approved product data can support crop, stage, issue, application, region and
                                    technical filters.</p>
                            </div>
                        </div>
                        <div className="faq-item reveal"><button className="faq-question"><span>Can the platform include weather or
                                    sensor data?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>Potentially, through approved providers and device interfaces. Coverage, accuracy,
                                    latency and usage terms depend on the source.</p>
                            </div>
                        </div>
                        ...
                        <div className="faq-item reveal"><button className="faq-question"><span>Does the platform replace agronomic
                                    advice?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>No. Recommendations and regulated product guidance must be approved by qualified
                                    agronomists and responsible organisations.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="final-box">
                        <div className="final-copy">
                            <p className="eyebrow" style={{"color":"#cdbdff"}}>Have a Agriculture &amp; Agritech project?</p>
                        ...
                        <form className="full-form js-demo-form" action="/api/leads" method="post"><input type="hidden"
                                name="source_page" value="industries/agriculture-agritech" /><input type="hidden"
                                name="offer" value="industries/agriculture-agritech-project-proposal" />
      ...
      <SiteFooter />
      <AgricultureAgritechClientScripts />
    </>
  );
}
