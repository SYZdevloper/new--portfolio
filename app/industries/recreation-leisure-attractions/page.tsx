...
import "./recreation-leisure-attractions.css";
...
export default function RecreationLeisureAttractionsPage() {
  return (
    <>
            ...
            <section className="hero" data-block-type="hero" data-block-id="industry-hero">
                <div className="container">
                    <div className="breadcrumbs"><a href="/">Home</a><span>/</span><a
                            href="/industries/">Industries</a><span>/</span><strong>Recreation, Leisure &amp;
                            Attractions</strong></div>
                    <div className="hero-grid">
                        <div className="hero-copy reveal">
                            <p className="eyebrow">Recreation, Leisure &amp; Attractions</p>
                            <h1>Turn visitor interest into easy bookings and better on-site experiences.</h1>
                            <p className="hero-lead">We build discovery websites, booking journeys and visitor platforms for
                                attractions, parks, leisure centres and recreation businesses.</p>
                            <div className="hero-points"><span>Present activities, tickets, facilities, schedules and
                                    accessibility clearly</span><span>Connect availability, bookings, memberships and
                                    payments</span><span>Support visitors, groups, events, capacity and operational
                                    reporting</span></div>
                        ...
                        <aside className="review-card reveal-right" id="free-review"><span className="review-badge">Free Recreation, Leisure
                                &amp; Attractions review</span>
                            ...
                            <form className="compact-form js-demo-form" action="/api/leads" method="post"><input
                                    ...
                                    value="industries/recreation-leisure-attractions" /><input type="hidden" name="offer"
                                    value="free-industries/recreation-leisure-attractions-review" /><input name="email"
                                    ...
                                    <option>Attraction &amp; Activity Websites</option>
                                    <option>Tickets, Passes &amp; Booking</option>
                                    <option>Membership &amp; Visitor Accounts</option>
                                    <option>Groups, Events &amp; Education</option>
                                    <option>Visitor Operations Dashboards</option>
                ...
                <div className="container">
                    ...
                    <div className="problem-grid">
                        <article className="problem-card reveal-zoom"><span className="problem-num">01</span>
                            <h3>Visitors cannot compare tickets and experiences.</h3>
                            <p>The current journey creates avoidable manual work, uncertainty or repeated follow-up.</p>
                            <span className="outcome">Outcome: Clear products, schedules, inclusions and suitability</span>
                        </article>
                        <article className="problem-card reveal-zoom"><span className="problem-num">02</span>
                            <h3>Booking rules create confusion at checkout.</h3>
                            <p>The current journey creates avoidable manual work, uncertainty or repeated follow-up.</p>
                            <span className="outcome">Outcome: Connected date, time, guest, add-on and payment
                                journeys</span>
                        </article>
                        <article className="problem-card reveal-zoom"><span className="problem-num">03</span>
                            <h3>Visitor updates and service information are fragmented.</h3>
                            <p>The current journey creates avoidable manual work, uncertainty or repeated follow-up.</p>
                            <span className="outcome">Outcome: One account, ticket, alert and support experience</span>
                        </article>
                    </div>
                </div>
            </section>
                    ...
                    <div className="solutions-shell">
                        <div className="solution-tabs reveal">
                            ...
                            <h2>Connected digital capabilities across the industry lifecycle.</h2><button
                                className="solution-tab active" data-key="discover"><span>01</span><span>Attraction &amp;
                                    Activity Websites</span><span>→</span></button><button className="solution-tab"
                                data-key="booking"><span>02</span><span>Tickets, Passes &amp;
                                    Booking</span><span>→</span></button><button className="solution-tab"
                                data-key="members"><span>03</span><span>Membership &amp; Visitor
                                    Accounts</span><span>→</span></button><button className="solution-tab"
                                data-key="groups"><span>04</span><span>Groups, Events &amp;
                                    Education</span><span>→</span></button><button className="solution-tab"
                                data-key="operations"><span>05</span><span>Visitor Operations
                                    Dashboards</span><span>→</span></button>
                        </div>
                        <div className="solution-panel reveal-right">
                            <div className="solution-copy"><span className="mini" id="solutionKicker">Visitor desire</span>
                                <h3 id="solutionTitle">Help visitors understand what to do and plan confidently.</h3>
                                <p id="solutionText">Structure attractions, activities, age guidance, accessibility,
                                    facilities, maps, schedules, media and policies.</p>
                                <div className="solution-list" id="solutionList"><span>Experience pages</span><span>Maps and
                                        schedules</span><span>Accessibility information</span></div><a className="btn"
                                    href="#project-enquiry">Discuss this capability →</a>
                            </div>
                            <div className="ui-window" aria-hidden="true">
                                <div className="ui-top">
                                    <div className="ui-dots"><i></i><i></i><i></i></div><span className="ui-badge"
                                        id="uiBadge">Attraction &amp; Activity Websites</span>
                                </div>
            ...
            <section className="section soft" data-block-type="childIndustryGrid">
                <div className="container">
                    ...
                    <div className="category-grid"><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Theme Parks &amp; Attractions</h3>
                            <p>Experiences, tickets, passes, maps and visitor operations.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Museums &amp; Cultural Attractions</h3>
                            <p>Programs, timed entry, memberships, learning and access.</p><span>Discuss category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Leisure &amp; Recreation Centres</h3>
                            <p>Activities, facilities, schedules, memberships and bookings.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Adventure &amp; Outdoor Experiences</h3>
                            <p>Activities, suitability, waivers, dates, guides and guests.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Family Entertainment Venues</h3>
                            <p>Packages, parties, tickets, food, memberships and visits.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Tours &amp; Visitor Experiences</h3>
                            <p>Schedules, languages, tickets, groups and meeting points.</p><span>Discuss
                                category</span>
                        </a></div>
                </div>
            </section>
            <section className="section" data-block-type="faq" id="faq">
                <div className="container">
                    ...
                    <div className="faq-list">
                        <div className="faq-item open"><button className="faq-question"><span>What recreation and attraction
                                    businesses do you support?</span><span>−</span></button>
                            <div className="faq-answer">
                                <p>We support theme parks, museums, recreation centres, outdoor experiences, family
                                    venues and visitor tours.</p>
                            </div>
                        </div>
                        <div className="faq-item reveal"><button className="faq-question"><span>Can visitors book timed tickets and
                                    add-ons?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>Yes. Workflows can support dates, times, capacity, ticket types, extras, promo codes,
                                    payment and confirmation.</p>
                            </div>
                        </div>
                        <div className="faq-item reveal"><button className="faq-question"><span>Can the platform support memberships
                                    and annual passes?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>Yes, through suitable identity, ticketing and payment capabilities.</p>
                            </div>
                        </div>
                        <div className="faq-item reveal"><button className="faq-question"><span>Can groups and schools request
                                    quotations?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>Yes. Forms can capture group type, size, date, activities, accessibility, catering,
                ...
                <div className="container">
                    <div className="final-box">
                        <div className="final-copy">
                            <p className="eyebrow" style={{"color":"#cdbdff"}}>Have a Recreation, Leisure &amp; Attractions
                                project?</p>
                        ...
                        <form className="full-form js-demo-form" action="/api/leads" method="post"><input type="hidden"
                                name="source_page" value="industries/recreation-leisure-attractions" /><input
                                type="hidden" name="offer"
                                value="industries/recreation-leisure-attractions-project-proposal" />
      ...
      <SiteFooter />
      <RecreationLeisureAttractionsClientScripts />
    </>
  );
}
