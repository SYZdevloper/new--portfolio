...
import "./edtech-online-learning.css";
...
export default function EdtechOnlineLearningPage() {
  return (
    <>
            ...
            <section className="hero" data-block-type="hero" data-block-id="industry-hero">
                <div className="container">
                    <div className="breadcrumbs"><a href="/">Home</a><span>/</span><a
                            href="/industries/">Industries</a><span>/</span><strong>EdTech &amp; Online
                            Learning</strong></div>
                    <div className="hero-grid">
                        <div className="hero-copy reveal">
                            <p className="eyebrow">EdTech &amp; Online Learning</p>
                            <h1>Build learning products that are easier to discover, start, complete and improve.</h1>
                            <p className="hero-lead">We build product websites, course marketplaces and learning platforms
                                for EdTech companies, online academies and digital-learning providers.</p>
                            <div className="hero-points"><span>Explain courses, outcomes, pathways, pricing and credentials
                                    clearly</span><span>Connect enrolment, payments, learning, assessment and
                                    support</span><span>Support learners, instructors, organisations, content teams and
                                    product analytics</span></div>
                        ...
                        <aside className="review-card reveal-right" id="free-review"><span className="review-badge">Free EdTech &amp; Online
                            ...
                            <form className="compact-form js-demo-form" action="/api/leads" method="post"><input
                                    type="hidden" name="source_page" value="industries/edtech-online-learning" /><input
                                    type="hidden" name="offer"
                                    value="free-industries/edtech-online-learning-review" /><input name="email"
                                    ...
                                    <option>Course Marketplaces &amp; Product Websites</option>
                                    <option>Learning Management Experiences</option>
                                    <option>Assessment &amp; Credentials</option>
                                    <option>Instructor &amp; Organisation Portals</option>
                                    <option>Learning Product Analytics</option>
                ...
                <div className="container">
                    ...
                    <div className="problem-grid">
                        <article className="problem-card reveal-zoom"><span className="problem-num">01</span>
                            <h3>Learners cannot tell which course matches their goal.</h3>
                            <p>The current journey creates avoidable manual work, uncertainty or repeated follow-up.</p>
                            <span className="outcome">Outcome: Clear pathway, level, format, outcome and prerequisite
                                guidance</span>
                        </article>
                        <article className="problem-card reveal-zoom"><span className="problem-num">02</span>
                            <h3>Registration and learning feel like separate products.</h3>
                            <p>The current journey creates avoidable manual work, uncertainty or repeated follow-up.</p>
                            <span className="outcome">Outcome: Connected discovery, purchase, onboarding and study
                                journey</span>
                        </article>
                        <article className="problem-card reveal-zoom"><span className="problem-num">03</span>
                            <h3>Teams cannot see where learners lose momentum.</h3>
                            <p>The current journey creates avoidable manual work, uncertainty or repeated follow-up.</p>
                            <span className="outcome">Outcome: Useful engagement, progression and support indicators</span>
                        </article>
                    </div>
                </div>
            </section>
                    ...
                    <div className="solutions-shell">
                        <div className="solution-tabs reveal">
                            ...
                            <h2>Connected digital capabilities across the industry lifecycle.</h2><button
                                className="solution-tab active" data-key="marketplace"><span>01</span><span>Course
                                    Marketplaces &amp; Product Websites</span><span>→</span></button><button
                                className="solution-tab" data-key="learning"><span>02</span><span>Learning Management
                                    Experiences</span><span>→</span></button><button className="solution-tab"
                                data-key="assessment"><span>03</span><span>Assessment &amp;
                                    Credentials</span><span>→</span></button><button className="solution-tab"
                                data-key="instructors"><span>04</span><span>Instructor &amp; Organisation
                                    Portals</span><span>→</span></button><button className="solution-tab"
                                data-key="analytics"><span>05</span><span>Learning Product
                                    Analytics</span><span>→</span></button>
                        </div>
                        <div className="solution-panel reveal-right">
                            <div className="solution-copy"><span className="mini" id="solutionKicker">Course conversion</span>
                                <h3 id="solutionTitle">Help learners choose an appropriate course or pathway.</h3>
                                <p id="solutionText">Structure topics, skills, levels, formats, instructors, outcomes,
                                    prerequisites, previews, pricing, reviews and FAQs.</p>
                                <div className="solution-list" id="solutionList"><span>Course search</span><span>Pathway
                                        comparison</span><span>Checkout and enrolment</span></div><a className="btn"
                                    href="#project-enquiry">Discuss this capability →</a>
                            </div>
                            <div className="ui-window" aria-hidden="true">
                                <div className="ui-top">
                                    <div className="ui-dots"><i></i><i></i><i></i></div><span className="ui-badge"
                                        id="uiBadge">Course Marketplaces &amp; Product Websites</span>
                                </div>
            ...
            <section className="section soft" data-block-type="childIndustryGrid">
                <div className="container">
                    ...
                    <div className="category-grid"><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Consumer Learning Platforms</h3>
                            <p>Course discovery, subscriptions, learning and credentials.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Professional Upskilling Providers</h3>
                            <p>Skills, pathways, projects, certificates and career outcomes.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Corporate Learning Platforms</h3>
                            <p>Organisations, seats, cohorts, assignments and reporting.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>K–12 Learning Products</h3>
                            <p>Learners, guardians, teachers, curriculum and age-appropriate experiences.</p>
                            <span>Discuss category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Higher-Education Technology</h3>
                            <p>Institutions, courses, integrations, assessment and analytics.</p><span>Discuss
                                category</span>
                        </a><a className="category-card" href="#project-enquiry"><b>↗</b>
                            <h3>Creator &amp; Expert Academies</h3>
                            <p>Instructors, programmes, communities, subscriptions and learner support.</p><span>Discuss
                                category</span>
                        </a></div>
                </div>
            </section>
            <section className="section" data-block-type="faq" id="faq">
                <div className="container">
                    ...
                    <div className="faq-list">
                        <div className="faq-item open"><button className="faq-question"><span>What EdTech and online-learning
                                    businesses do you support?</span><span>−</span></button>
                            <div className="faq-answer">
                                <p>We support consumer, professional, corporate, K–12 and higher-education platforms,
                                    plus expert-led online academies.</p>
                            </div>
                        </div>
                        <div className="faq-item reveal"><button className="faq-question"><span>Can you build subscriptions, course
                                    purchases and enrolment?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>Yes. Journeys can support catalogues, plans, promotions, checkout, access rules,
                                    enrolment and account management.</p>
                            </div>
                        </div>
                        <div className="faq-item reveal"><button className="faq-question"><span>Can the platform include interactive
                                    learning activities?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>Yes. Activities can include quizzes, scenarios, simulations, matching, branching,
                                    practice tasks and other accessible HTML-based interactions.</p>
                            </div>
                        </div>
                        <div className="faq-item reveal"><button className="faq-question"><span>Can learners receive certificates or
                                    badges?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>Yes, based on approved completion and assessment rules, with shareable or verifiable
                                    credentials where required.</p>
                            </div>
                        </div>
                        ...
                        <div className="faq-item reveal"><button className="faq-question"><span>Who is responsible for curriculum
                                    accuracy and learner data?</span><span>+</span></button>
                            <div className="faq-answer">
                                <p>The education provider remains responsible for curriculum, assessment validity,
                                    age-appropriate design, consent, privacy and any accreditation claims.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="final-box">
                        <div className="final-copy">
                            <p className="eyebrow" style={{"color":"#cdbdff"}}>Have a EdTech &amp; Online Learning project?</p>
                        ...
                        <form className="full-form js-demo-form" action="/api/leads" method="post"><input type="hidden"
                                name="source_page" value="industries/edtech-online-learning" /><input type="hidden"
                                name="offer" value="industries/edtech-online-learning-project-proposal" />
      ...
      <SiteFooter />
      <EdtechOnlineLearningClientScripts />
    </>
  );
}
