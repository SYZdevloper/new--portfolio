...
export const metadata: Metadata = {
  alternates: { canonical: "/services/merchandising-and-analytics/" },
  title: "Merchandising & Analytics | Hyperlink Tech Solutions",
  description: "We aggregate data from storefronts, inventory systems, and marketing platforms into executive dashboards to optimize merchandising, pricing, and campaign performance.",
};
            ...
            <section className="hero service-hero" aria-labelledby="service-title">
                ...
                <div className="container hero-grid">
                    <div className="hero-copy reveal">
                        ...
                        <h1 id="service-title">Data-driven retail operations.</h1>
                        <p className="hero-lead">We aggregate data from storefronts, inventory systems, and marketing platforms into executive dashboards to optimize merchandising, pricing, and campaign performance.</p>
                        <ul className="hero-points" style={{ listStyle: "none", padding: 0 }}>
                            <li>Unified BI dashboards tracking conversion rates, AOV, and inventory turnover</li>
                            <li>Predictive analytics for demand forecasting and stock replenishment</li>
                            <li>Custom merchandising tools for dynamic pricing and campaign management</li>
                        </ul>
                ...
                <div className="container">
                    <div className="proof-bar-inner" aria-label="Platform benefits">
                        ...
                        <div className="proof-item">
                            ...
                            <strong>Consolidate fragmented retail data into clear, actionable metrics.</strong>
                        </div>
                        <div className="proof-item">
                            <small>02 · Inventory Optimization</small>
                            <strong>Forecast demand accurately to prevent stockouts and overstocking.</strong>
                        </div>
                        <div className="proof-item">
                            <small>03 · Campaign ROI</small>
                            <strong>Track the exact impact of marketing campaigns on sales velocity.</strong>
                        </div>
                        <div className="proof-item">
                            <small>04 · Agile Merchandising</small>
                            <strong>Tools to quickly adjust pricing or product placement based on real-time data.</strong>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <section className="section" id="problems">
                <div className="container content-intro">
                    <aside className="content-intro-aside">
                        ...
                        <p>You can't optimize what you can't see clearly.</p>
                        <a className="btn" href="#contact">Discuss Strategy <span className="arrow">↗</span></a>
                    </aside>

                    <div className="content-intro-main">
                        <h2>Fragmented data leads to missed opportunities.</h2>
                        <p>Retail managers often struggle with data spread across Shopify, Google Analytics, their ERP, and marketing tools. This fragmentation makes it impossible to quickly understand product performance, optimize merchandising, or manage inventory effectively.</p>
                        ...
                        <div className="problem-grid">
                            ...
                            <article className="problem-card">
                                ...
                                <p>Product placements are based on guesswork rather than real-time conversion data.</p>
                            </article>
                            <article className="problem-card">
                                <span className="problem-card-number">02</span>
                                <h3>Inventory Mismanagement</h3>
                                <p>Stockouts cost sales, while overstocking ties up capital, due to poor demand forecasting.</p>
                            </article>
                            <article className="problem-card">
                                <span className="problem-card-number">03</span>
                                <h3>Reporting Fatigue</h3>
                                <p>Analysts spend hours manually compiling reports in Excel instead of analyzing trends.</p>
                            </article>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="solution-shell">
                        <div className="solution-head">
                            ...
                            <p>We build data platforms and custom tooling that give your team the power to merchandise and operate with precision.</p>
                        </div>
                        ...
                        <div className="deliverable-grid">
                            ...
                            <article className="deliverable-card">
                                ...
                                <p>Custom BI interfaces tracking high-level KPIs like CAC, LTV, and margin performance across channels.</p>
                                <div className="deliverable-tags"><small>BI</small><small>Dashboards</small><small>Metrics</small></div>
                            </article>
                            <article className="deliverable-card">
                                <span>02 · Core</span>
                                <h3>Data Warehousing</h3>
                                <p>Pipelines extracting data from commerce platforms, POS systems, and ad networks into a central repository.</p>
                                <div className="deliverable-tags"><small>ETL</small><small>Data</small><small>Cloud</small></div>
                            </article>
                            <article className="deliverable-card">
                                <span>03 · Core</span>
                                <h3>Dynamic Pricing Engines</h3>
                                <p>Custom logic to adjust pricing based on inventory levels, competitor data, or specific customer segments.</p>
                                <div className="deliverable-tags"><small>Logic</small><small>Pricing</small><small>APIs</small></div>
                            </article>
                            <article className="deliverable-card">
                                <span>04 · Core</span>
                                <h3>Custom Merchandising Tools</h3>
                                <p>Interfaces allowing marketing teams to easily build product bundles, manage flash sales, or curate collections.</p>
                                <div className="deliverable-tags"><small>Tools</small><small>React</small><small>Operations</small></div>
                            </article>
                        </div>
                    </div>
                </div>
