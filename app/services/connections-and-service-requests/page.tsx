...
export const metadata: Metadata = {
  alternates: { canonical: "/services/connections-and-service-requests/" },
  title: "Connections & Service Requests | Hyperlink Tech Solutions",
  description: "We engineer intelligent digital forms that guide developers and homeowners through complex new connection applications and streamline fault reporting into your CRM.",
};
            ...
            <section className="hero service-hero" aria-labelledby="service-title">
                ...
                <div className="container hero-grid">
                    <div className="hero-copy reveal">
                        <div className="hero-status">Service Workflows</div>
                        <p className="eyebrow">Digital Workflows</p>
                        <h1 id="service-title">Digitize new connections and fault reporting.</h1>
                        <p className="hero-lead">We engineer intelligent digital forms that guide developers and homeowners through complex new connection applications and streamline fault reporting into your CRM.</p>
                        <ul className="hero-points" style={{ listStyle: "none", padding: 0 }}>
                            <li>Dynamic logic forms that adapt based on whether the user is a homeowner or commercial developer</li>
                            <li>Geospatial integration allowing users to drop a pin on a map to report a fault (e.g., burst pipe, downed line)</li>
                            <li>Automated routing of applications directly into Salesforce, SAP, or Maximo</li>
                        </ul>
                ...
                <div className="container">
                    <div className="proof-bar-inner" aria-label="Platform benefits">
                        ...
                        <div className="proof-item">
                            ...
                            <strong>Ensure connection applications are submitted with all required documents the first time.</strong>
                        </div>
                        <div className="proof-item">
                            <small>02 · Accurate Faults</small>
                            <strong>Collect precise GPS data and photos from citizens reporting issues.</strong>
                        </div>
                        <div className="proof-item">
                            <small>03 · CRM Automation</small>
                            <strong>Eliminate manual data entry for your customer service representatives.</strong>
                        </div>
                        <div className="proof-item">
                            <small>04 · Status Tracking</small>
                            <strong>Allow developers to track their application status online.</strong>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <section className="section" id="problems">
                <div className="container content-intro">
                    <aside className="content-intro-aside">
                        <p className="eyebrow">When applications require PDFs</p>
                        <p>A 20-page PDF form is a terrible way to start a customer relationship.</p>
                        <a className="btn" href="#contact">Discuss Strategy <span className="arrow">↗</span></a>
                    </aside>

                    <div className="content-intro-main">
                        <h2>Manual applications throttle your network growth.</h2>
                        <p>Applying for a new water or power connection is inherently complex. When you force developers or homeowners to fill out static PDF forms, you guarantee missing information, back-and-forth emails, and delayed project timelines.</p>
                        ...
                        <div className="problem-grid">
                            ...
                            <article className="problem-card">
                                ...
                                <p>Applications are submitted missing critical engineering diagrams, requiring manual follow-up.</p>
                            </article>
                            <article className="problem-card">
                                <span className="problem-card-number">02</span>
                                <h3>Vague Fault Reports</h3>
                                <p>A citizen calls to report a leak 'near the big tree on Main Street,' making it impossible for crews to find quickly.</p>
                            </article>
                            <article className="problem-card">
                                <span className="problem-card-number">03</span>
                                <h3>Data Entry Burden</h3>
                                <p>Staff spend hours manually typing data from PDFs into the central CRM system.</p>
                            </article>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="solution-shell">
                        <div className="solution-head">
                            <div>
                                ...
                                <h2>Intelligent data capture.</h2>
                            </div>
                            <p>We build smart workflows that collect exact information and route it instantly.</p>
                        </div>
                        ...
                        <div className="deliverable-grid">
                            ...
                            <article className="deliverable-card">
                                <span>01 · Core</span>
                                <h3>Dynamic Application Forms</h3>
                                <p>Multi-step React forms that use conditional logic to only ask questions relevant to the specific connection type.</p>
                                <div className="deliverable-tags"><small>React</small><small>Logic</small><small>Forms</small></div>
                            </article>
                            <article className="deliverable-card">
                                <span>02 · Core</span>
                                <h3>Map-Based Fault Reporting</h3>
                                <p>Integrations with Google Maps or Mapbox, allowing users to drop a pin, upload a photo, and submit a precise defect location.</p>
                                <div className="deliverable-tags"><small>Maps</small><small>Geo</small><small>UX</small></div>
                            </article>
                            <article className="deliverable-card">
                                <span>03 · Core</span>
                                <h3>Document Validation</h3>
                                <p>Workflows that force developers to upload required CAD files or site plans before they can click submit.</p>
                                <div className="deliverable-tags"><small>Uploads</small><small>Validation</small><small>AWS</small></div>
                            </article>
                            <article className="deliverable-card">
                                <span>04 · Core</span>
                                <h3>CRM Webhooks</h3>
                                <p>Direct API integrations that push new applications and fault reports into Salesforce or Microsoft Dynamics instantly.</p>
                                <div className="deliverable-tags"><small>APIs</small><small>Salesforce</small><small>Sync</small></div>
                            </article>
                        </div>
                    </div>
                </div>
