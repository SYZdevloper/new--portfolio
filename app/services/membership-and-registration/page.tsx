...
export const metadata: Metadata = {
  alternates: { canonical: "/services/membership-and-registration/" },
  title: "Membership & Registration | Hyperlink Tech Solutions",
  description: "We engineer custom registration flows that handle complex family discounts, age-grade logic, and direct-debit subscription billing seamlessly.",
};
            ...
            <section className="hero service-hero" aria-labelledby="service-title">
                ...
                <div className="container hero-grid">
                    <div className="hero-copy reveal">
                        <div className="hero-status">Registration Engines</div>
                        <p className="eyebrow">Growth</p>
                        <h1 id="service-title">Frictionless member onboarding.</h1>
                        <p className="hero-lead">We engineer custom registration flows that handle complex family discounts, age-grade logic, and direct-debit subscription billing seamlessly.</p>
                        <ul className="hero-points" style={{ listStyle: "none", padding: 0 }}>
                            <li>Custom React-based registration flows that eliminate confusing, generic third-party forms</li>
                            <li>Intelligent logic calculating complex state vouchers, third-child discounts, and prorated mid-season fees</li>
                            <li>Seamless digital checkout supporting Apple Pay and automated recurring billing via Stripe</li>
                        </ul>
                ...
                <div className="container">
                    <div className="proof-bar-inner" aria-label="Platform benefits">
                        ...
                        <div className="proof-item">
                            ...
                            <strong>Turn a frustrating 20-minute form into a smooth, 2-minute mobile checkout.</strong>
                        </div>
                        <div className="proof-item">
                            <small>02 · Reduced Admin</small>
                            <strong>Stop your club volunteers from manually chasing unpaid fees via spreadsheet.</strong>
                        </div>
                        <div className="proof-item">
                            <small>03 · Accurate Pricing</small>
                            <strong>Guarantee that complex family capping rules are applied correctly every time.</strong>
                        </div>
                        <div className="proof-item">
                            <small>04 · Automated Renewals</small>
                            <strong>Reduce churn by implementing frictionless, card-on-file membership renewals.</strong>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <section className="section" id="problems">
                <div className="container content-intro">
                    <aside className="content-intro-aside">
                        <p className="eyebrow">When registration is painful</p>
                        <p>If a parent has to fill out the same medical details three times for three kids, they will complain.</p>
                        <a className="btn" href="#contact">Discuss Strategy <span className="arrow">↗</span></a>
                    </aside>

                    <div className="content-intro-main">
                        <h2>Clunky registration destroys growth.</h2>
                        <p>Sporting bodies spend months planning the season, only to force members through a generic, out-of-the-box form that looks terrible on mobile. When the registration engine cannot handle the reality of family linking or fails to apply government sports vouchers, the administrative burden falls onto stressed volunteers.</p>
                        ...
                        <div className="problem-grid">
                            ...
                            <article className="problem-card">
                                ...
                                <p>Users quit the registration process because the legacy system keeps crashing when they try to upload a photo.</p>
                            </article>
                            <article className="problem-card">
                                <span className="problem-card-number">02</span>
                                <h3>Manual Math Errors</h3>
                                <p>Volunteers spend hours manually calculating refunds because the system didn't automatically apply a family discount.</p>
                            </article>
                            <article className="problem-card">
                                <span className="problem-card-number">03</span>
                                <h3>Inflexible Payments</h3>
                                <p>You lose members because the legacy system cannot support flexible payment plans or split direct debits.</p>
                            </article>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="solution-shell">
                        <div className="solution-head">
                            <div>
                                ...
                                <h2>Automated membership commerce.</h2>
                            </div>
                            <p>We engineer registration engines that handle the complex math of sports associations while remaining beautiful.</p>
                        </div>
                        ...
                        <div className="deliverable-grid">
                            ...
                            <article className="deliverable-card">
                                <span>01 · Core</span>
                                <h3>Custom Registration Frontends</h3>
                                <p>Building bespoke React flows that keep the member on your domain from data entry to payment.</p>
                                <div className="deliverable-tags"><small>UX</small><small>React</small><small>Conversion</small></div>
                            </article>
                            <article className="deliverable-card">
                                <span>02 · Core</span>
                                <h3>Complex Pricing Logic</h3>
                                <p>Ensuring that age-restrictions, multi-child discounts, and government voucher codes (like Active Kids) are validated and calculated instantly.</p>
                                <div className="deliverable-tags"><small>Logic</small><small>Pricing</small><small>Rates</small></div>
                            </article>
                            <article className="deliverable-card">
                                <span>03 · Core</span>
                                <h3>CRM API Middleware</h3>
                                <p>Developing secure Node.js layers that push the sanitized registration data directly into Salesforce or your sports CRM.</p>
                                <div className="deliverable-tags"><small>APIs</small><small>Integration</small><small>Data</small></div>
                            </article>
                            <article className="deliverable-card">
                                <span>04 · Core</span>
                                <h3>Subscription Billing</h3>
                                <p>Implementing Stripe Billing to handle recurring payments, failed card retries, and automated receipt generation.</p>
