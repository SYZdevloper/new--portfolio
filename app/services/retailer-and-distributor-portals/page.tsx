...
export const metadata: Metadata = {
  alternates: { canonical: "/services/retailer-and-distributor-portals/" },
  title: "Retailer & Distributor Portals | Hyperlink Tech Solutions",
  description: "We engineer secure B2B portals where major retailers and independent stockists can easily place bulk orders, access merchandising guidelines, and download high-res campaign assets.",
};
            ...
            <section className="hero service-hero" aria-labelledby="service-title">
                ...
                <div className="container hero-grid">
                    <div className="hero-copy reveal">
                        ...
                        <h1 id="service-title">Empower your wholesale channel.</h1>
                        <p className="hero-lead">We engineer secure B2B portals where major retailers and independent stockists can easily place bulk orders, access merchandising guidelines, and download high-res campaign assets.</p>
                        <ul className="hero-points" style={{ listStyle: "none", padding: 0 }}>
                            <li>Custom B2B ordering engines featuring complex case-pack rules and customer-specific tier pricing</li>
                            <li>Self-serve marketing hubs where retailers can download authorized brand assets and POS displays</li>
                            <li>Seamless integration with legacy manufacturing ERPs (SAP, NetSuite) for live inventory visibility</li>
                        </ul>
                ...
                <div className="container">
                    <div className="proof-bar-inner" aria-label="Platform benefits">
                        ...
                        <div className="proof-item">
                            ...
                            <strong>Ensure every wholesale buyer sees their exact negotiated tier pricing.</strong>
                        </div>
                        <div className="proof-item">
                            <small>02 · Brand Consistency</small>
                            <strong>Give stockists instant access to the correct, up-to-date campaign imagery.</strong>
                        </div>
                        <div className="proof-item">
                            <small>03 · Faster Ordering</small>
                            <strong>Replace emailed Excel order forms with a streamlined digital B2B cart.</strong>
                        </div>
                        <div className="proof-item">
                            <small>04 · Self-Serve Admin</small>
                            <strong>Retailers can download invoices and track shipments without calling your team.</strong>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="content-intro-main">
                        ...
                        <div className="problem-grid">
                            ...
                            <article className="problem-card">
                                ...
                                <p>A rep miskeys an order from an email, resulting in the wrong SKU being shipped to a major department store.</p>
                            </article>
                            <article className="problem-card">
                                <span className="problem-card-number">02</span>
                                <h3>Brand Dilution</h3>
                                <p>Independent retailers use blurry, outdated imagery on their websites because they can't access your current campaign assets.</p>
                            </article>
                            <article className="problem-card">
                                <span className="problem-card-number">03</span>
                                <h3>Stockout Frustration</h3>
                                <p>Buyers place bulk orders blindly without knowing if the product is actually in your warehouse, leading to backorders.</p>
                            </article>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="solution-shell">
                        <div className="solution-head">
                            ...
                            <p>We build bespoke wholesale platforms that understand the specific business logic of consumer brands.</p>
                        </div>
                        ...
                        <div className="deliverable-grid">
                            ...
                            <article className="deliverable-card">
                                <span>01 · Core</span>
                                <h3>Custom Pricing Logic</h3>
                                <p>Middleware that queries the ERP in real-time to display the correct price based on the logged-in retailer's specific contract.</p>
                                <div className="deliverable-tags"><small>Logic</small><small>Pricing</small><small>APIs</small></div>
                            </article>
                            <article className="deliverable-card">
                                <span>02 · Core</span>
                                <h3>B2B Order Grids</h3>
                                <p>Custom React interfaces allowing buyers to add dozens of variants (sizes/colors) to their cart simultaneously from a single grid.</p>
                                <div className="deliverable-tags"><small>UX</small><small>Cart</small><small>React</small></div>
                            </article>
                            <article className="deliverable-card">
                                <span>03 · Core</span>
                                <h3>Brand Asset Vaults</h3>
                                <p>Secure, gated directories within the portal where retailers can download localized merchandising guidelines and high-res imagery.</p>
                                <div className="deliverable-tags"><small>DAM</small><small>Assets</small><small>Brand</small></div>
                            </article>
                            <article className="deliverable-card">
                                <span>04 · Core</span>
                                <h3>ERP Middleware</h3>
                                <p>Secure Node.js translation layers that read/write orders directly into SAP or Epicor without exposing the core database.</p>
